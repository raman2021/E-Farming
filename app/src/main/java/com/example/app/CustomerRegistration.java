...
public class CustomerRegistration extends AppCompatActivity {
    ...
    String firstF, lastF, emailF, passF, cpassF, role = "Customer";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EmailF = (TextInputLayout) findViewById(R.id.Emailaddress);
        PassF = (TextInputLayout) findViewById(R.id.PasswordC);
        CpassF = (TextInputLayout) findViewById(R.id.ConfirmPasswordC);


        reg = (Button) findViewById(R.id.Cregister);
        mail = (Button) findViewById(R.id.emailC);

        databaseReference = firebaseDatabase.getInstance("https://e-farming-c93ab-default-rtdb.firebaseio.com/").getReference("Customer");
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    ...
                    final ProgressDialog fDialog = new ProgressDialog(CustomerRegistration.this);
                            ...
                            if (task.isSuccessful()) {
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        firebaseDatabase.getInstance("https://e-farming-c93ab-default-rtdb.firebaseio.com/").getReference("Customer")
        ...
        EmailF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(CustomerRegistration.this, CustomerPage.class);
                startActivity(i);
                finish();
            }
        });
